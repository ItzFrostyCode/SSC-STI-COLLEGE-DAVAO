class SoundManager {
  ...
  attachDelegatedListeners() {
    const selector =
      'a, button, .card, .officer-card, .stat-card, .btn-primary, .btn-outline, .btn-audio, .search-toggle-btn, .hamburger, .theme-toggle, input[type="submit"], input[type="button"], [role="button"]';
    let lastTime = 0;
